...
PYBIND11_MODULE(games, m)
{
    ...
    .def("path2str",      &PyState0::path2str, "ations list to string")
    ...
    .def("path2str",      &PyState1::path2str, "ations list to string")
    ...
    .def("path2str",      &PyState2::path2str, "ations list to string")
    ...
    .def("path2str",      &PyState3::path2str, "ations list to string")
